...
namespace ZEMS.Data.Migrations
{
    public partial class InitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZEMSApiClient", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZEMSUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ZEMSUser_AspNetUsers_IdentityId",
            ...
            migrationBuilder.Sql(@"INSERT INTO dbo.ZEMSUser ([FullName],[IdentityId])
            ...
            migrationBuilder.Sql(@"Insert Into [dbo].[ZEMSApiClient] (CreatedDate,UpdatedDate,CreatedByUsername,UpdatedByUsername,Token,Expiry)
